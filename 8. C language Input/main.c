...
scanf(" %c", &grade); লাইনে %c এর ঠিক আগে একটি স্পেস (" %c") দেওয়া হয়েছে ইনপুট বাফারে জমা হয়ে থাকা অতিরিক্ত Newline (\n) বা স্পেসকে স্কিপ (Skip) করার জন্য।


কেন এই স্পেস দেওয়া আবশ্যক?
১. %d বা %f এর স্বভাব:
scanf("%d", ...) বা scanf("%f", ...) যখন কাজ করে, তারা ইনপুট নেওয়ার সময় বাফারে থাকা যেকোনো স্পেস, ট্যাব বা Newline (\n) স্বয়ংক্রিয়ভাবে বাদ দিয়ে বা স্কিপ করে শুধু সংখ্যাটিকে গ্রহণ করে।

২. %c এর স্বভাব (একদম আলাদা):
%c কিন্তু কোনো স্পেস বা \n স্কিপ করে না! কিবোর্ড থেকে চাপ দেওয়া যেকোনো ক্যারেক্টারকে (এমনকি Enter বা Space-কেও) সে একটি বৈধ ক্যারেক্টার মনে করে গিলে ফেলে।


scanf এর ফরম্যাট স্ট্রিংয়ের ভেতর একটি স্পেস :
scanf(" %c", &grade);


তখন সি কম্পাইলারকে বিশেষ একটি নির্দেশনা দেওয়া হয়: "বাফারে আগে থেকে যেসব Whitespace ক্যারেক্টার (যেমন: Enter \n, Space, Tab) জমা হয়ে আছে,
সেগুলোকে সব ইগনোর করে ফেলে দাও। তারপর ইউজার নতুন যে ক্যারেক্টার টাইপ করবে, শুধুমাত্র সেটিকে grade এ সেট করো।"


সংক্ষিপ্ত নিয়ম (Rule of Thumb)
C ল্যাঙ্গুয়েজে scanf দিয়ে কোনো একক ক্যারেক্টার (char) ইনপুট নেওয়ার সময় সবসময় ফরম্যাট স্পেসিফায়ারের আগে একটি স্পেস " %c" দেওয়া প্রফেশনাল ও নিরাপদ নিয়ম। 
এটি ব্যবহার করলে আলাদা করে getchar() লিখে বাফার পরিষ্কার না করলেও চলে।
---------------------------------------------------------------------------------------------------------
...
int main() {
  ...
  যখন  %s , s নিজেই বলে দেয় এটি স্ট্রিং।

  যখন  [...] (Square Brackets) ব্যবহার, তখন এই ব্র্যাকেটগুলোই নির্দেশ করে যে এখানে একটি ক্যারেক্টার অ্যারে বা স্ট্রিং ইনপুট নেওয়া হচ্ছে।

  তাই %[^\n]s লিখলে সেটি ভুল সিনট্যাক্স হবে। কারণ কম্পিউটার কনফিউজড হয়ে যাবে যে  কি Scanset ব্যবহার করা হসছে নাকি সাধারণ string (s)।
...
fgets() + strcspn() + while (getchar() != '\n'); কম্বিনেশনটি সবচেয়ে বেশি নিরাপদ ও প্রফেশনাল।

scanf(" %[^\n]", name) ব্যবহার করলে যদি ইউজার অ্যারের সাইজের চেয়ে বড় কোনো নাম টাইপ করে,
তবে Buffer Overflow ঘটে প্রোগ্রাম ক্র্যাশ করার বা সিকিউরিটি রিক্স তৈরি হওয়ার ঝুঁকি থাকে। 
অন্যদিকে fgets() মেমোরি লিমিট মেনে ইনপুট নেয়, তাই এটি শতভাগ নিরাপদ।
...
int main() {
    ...
    // ১. নাম ইনপুট (fgets দিয়ে নিরাপদ ইনপুট)
    printf("Enter Your Name: ");
    fgets(name, sizeof(name), stdin);
    name[strcspn(name, "\n")] = 0; // অতিরিক্ত Enter মুছ ফেলা

    // ২. বয়স ইনপুট
    printf("Enter Your Age: ");
    scanf("%d", &age);
    while (getchar() != '\n'); // বাফারের সব অতিরিক্ত অক্ষ ও Enter পরিষ্কার করা
    ...
    // ৭. গ্রেড ইনপুট
    printf("Enter Your GRADE: ");
    scanf(" %c", &grade); // %c এর আগে স্পেস রাখা হয়েছে
    while (getchar() != '\n');
